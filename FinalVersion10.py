...
Six_branches_list = ['BSLSKF', 'SYLSKF', 'CTGSKF', 'HZJSKF', 'FRDSKF', 'MHKSKF']
...
for each_branch in Six_branches_list:
    ...
    def autolabel(bars):
        for bar in bars:
            ...
            ax.text(bar.get_x() + bar.get_width() / 2., .995 * height,
                    get_value(str(height)) + "K",
                    ha='center', va='bottom', fontsize=12, rotation=10, fontweight='bold')
    ...
    # cc = ['hislam@skf.transcombd.com','muhammad.mainuddin@tdcl.transcombd.com','almamun@transcombd.com']
