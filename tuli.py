...
cc = ['biswascma@yahoo.com', '']
bcc = ['roseline@transcombd.com', 'rejaul.islam@transcombd.com', 'ekbal.kanon@transcombd.com']
...
subject = "SK+F Formulation Reports(Assignment) - By Roseline Tuli"
...
msgText = MIMEText("""
                       ...
                       <br> <br> Regards 
                       <br> Roseline Tuli 
                       <br>(Mobile: 01713-380503)</b><br><br>
                       """, 'html')
